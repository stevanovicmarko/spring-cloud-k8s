...
class BookRepositoryJdbcTests {
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", "Samizdat", 12.90);
        var book2 = Book.of("1234561236", "Another Title", "Author", "Samizdat", 12.90);
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", "Samizdat", 12.90);
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", "Samizdat", 12.90);
